              ...
              >
                <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1 bg-white">
                  ...
                  @if (Route::currentRouteName() != 'dashboard')
                    <a class="nav-item" href="{{route('dashboard')}}"><x-gmdi-dashboard-r class="mr-1"/> {{__('Dashboard')}}</a>
                  ...
                  <a href="{{route('user.edit', Auth::user()->name)}}"
                    ...
                    <x-fas-user class="mr-1"/> {{__('Profile')}}</a>
                  <a href="{{route('user.change-password', Auth::user()->name)}}"
                    ...
                    <x-fas-key class="mr-1"/> {{__('Change Password')}}</a>
                  ...
                  @csrf
                    <a href="{{route('logout')}}" onclick="event.preventDefault();
                      this.closest('form').submit();" class="nav-item" ><x-fas-sign-out-alt class="mr-1"/> {{__('Log Out')}}</a>
                  </form>
                </div>
              </div>
            </div>
        ...
        <div class="mt-3 space-y-1">
          ...
          @csrf
            <a class="nav-item" href="{{route('logout')}}" onclick="event.preventDefault();
              ...
              <x-fas-sign-out-alt class="mr-1"/> {{__('Log Out')}}</a>
          </form>
        </div>
      </div>
    @else
