            ...
            <div class="w-full max-w-4xl">
                ...
                @csrf
                    <div class="mt-1 text-center">
                        <input name="long_url" required value="{{ old('long_url') }}" placeholder="Shorten your link"
                    ...
                    <div class="custom-url sm:mt-8">
                        <b>Custom URL (optional)</b>
                        <span class="block mb-4 font-light dark:text-dark-400">
                            Replace clunky URLs with meaningful short links that get more clicks.</span>
