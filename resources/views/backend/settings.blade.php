            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <input name="site_name" value="{{ $settings->site_name }}"
                        class="form-input mt-1 @error('site_name') !border-red-300 @enderror">
                </div>
                ...
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <input name="keyword_length" value="{{ $settings->keyword_length }}"
                        class="form-input mt-1 @error('keyword_length') !border-red-300 @enderror">
                </div>
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <input name="custom_keyword_min_length" value="{{ $settings->custom_keyword_min_length }}"
                        class="form-input mt-1 @error('custom_keyword_min_length') !border-red-300 @enderror">
                </div>
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <input name="custom_keyword_max_length" value="{{ $settings->custom_keyword_max_length }}"
                        class="form-input mt-1 @error('custom_keyword_max_length') !border-red-300 @enderror">
                </div>
                <div class="col-span-6 lg:col-span-4">
                ...
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <select name="redirect_status_code" class="form-input mt-1">
                ...
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <input name="redirect_cache_max_age" value="{{ $settings->redirect_cache_max_age }}"
                        class="form-input mt-1 @error('redirect_cache_max_age') !border-red-300 @enderror">
                </div>
                <div class="col-span-6 lg:col-span-4">
