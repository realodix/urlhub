                ...
                <div class="flex flex-wrap sm:mt-8">
                    <div class="w-full sm:w-1/4">
                        ...
                        <div class="block">
                            ...
                            <span class="text-teal-600">{{compactNumber($url->numberOfClicksPerAuthor(auth()->id()))}}</span> -
            ...
            @else
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full sm:w-1/4">
                        ...
                        <span class="font-light text-lg sm:text-2xl">{{compactNumber($url->numberOfClicksPerAuthor(auth()->id()))}}</span>
                    </div>
                </div>
            @endrole
        </div>
