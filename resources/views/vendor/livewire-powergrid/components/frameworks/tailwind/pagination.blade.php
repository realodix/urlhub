...
@if ($paginator->hasPages())
        ...
        <a
            class="px-2 py-1 pt-2 m-1 text-center text-white bg-uh-2a hover:bg-uh-2c active:bg-uh-2b border-gray-400 rounded cursor-pointer border-1 hover:border-gray-800 dark:text-gray-300"
        ...
        <a class="px-2 py-1 pt-2 m-1 text-center text-white bg-uh-2a hover:bg-uh-2c active:bg-uh-2b border-gray-400 rounded cursor-pointer border-1 hover:border-gray-800 dark:text-gray-300"
            ...
            @if (is_array($element))
                ...
                @foreach ($element as $page => $url)
                    ...
                    @elseif ($page === $paginator->currentPage() + 1 || $page === $paginator->currentPage() + 2 || $page === $paginator->currentPage() - 1 || $page === $paginator->currentPage() - 2)
                        <a class="px-2 py-1 m-1 text-center text-white bg-uh-2a hover:bg-uh-2c active:bg-uh-2b border-gray-400 rounded cursor-pointer border-1 hover:border-gray-800 dark:text-gray-300"
