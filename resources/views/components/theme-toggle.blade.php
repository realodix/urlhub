<div class="bg-gray-950/5 dark:bg-dark-900 border border-border-200 dark:border-dark-800 rounded-full p-0.75 inline-flex">
    <button x-data x-on:click="$store.darkMode.light()"
        ...
        x-bind:class="$store.darkMode.mode == 'light' ?
            'bg-white text-gray-800 hover:text-gray-600 ring ring-gray-950/10'
            : ''
        "
    >
    ...
    <button x-data x-on:click="$store.darkMode.system()"
        class="rounded-full flex items-center justify-center focus:outline-none
            text-gray-500 hover:text-gray-800 dark:hover:text-emerald-500
            ml-2"
        x-bind:class="$store.darkMode.mode == 'system' ?
    ...
    <button x-data x-on:click="$store.darkMode.dark()"
        class="rounded-full flex items-center justify-center focus:outline-none
            text-gray-500 hover:text-gray-800 dark:hover:text-emerald-500
            ml-2"
        x-bind:class="$store.darkMode.mode == 'dark' ?
