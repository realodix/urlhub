        ...
        <div class="relative" x-data="{ open: false }" x-on:click.away="open = false">
            <div x-on:click="open = ! open">
                <button class="navbar-toggler items-center">
                    <div class="text-base font-semibold text-primary-800 dark:text-primary-500">
...
@else
    <a href="{{ route('login') }}"
        class="btn text-xl font-medium hover:bg-gray-100
            dark:!bg-dark-900 dark:hover:!bg-dark-900/40 dark:!text-primary-500 dark:hover:!border-primary-8500"
    >
