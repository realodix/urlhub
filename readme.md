...
![PHPVersion](https://img.shields.io/badge/PHP-%5E7.4-777BB4.svg?style=flat-square)
...
## Requirements
* All requirements by [Laravel](https://laravel.com/docs/installation#server-requirements) & dependencies - PHP >= 7.4, [Composer](https://getcomposer.org/) and such.
* MySQL or MariaDB.
